...
<div class="bg-gray-100">
   ...
   {{ request()->routeIs('produk.restore') ? 'bg-gray-700 text-white' : 'bg-white text-gray-800' }}">
                    ...
                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                        ...
                        <path
                            ...
                            stroke="#393838" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                ...
                <a href="{{ route('produk.index') }}"
                    class="inline-flex items-center gap-2 px-4 py-2 rounded
   {{ request()->routeIs('produk.index') ? 'bg-gray-700 text-white' : 'bg-white text-gray-800' }}">
                ...
                <a href="{{ route('produk.kelola_card') }}"
                    class="inline-flex items-center gap-2 px-4 py-2 rounded
   {{ request()->routeIs('produk.kelola_card') ? 'bg-gray-700 text-white' : 'bg-white text-gray-800' }}">
                ...
                <a href="{{ route('produk.create') }}"
                    class="inline-flex items-center gap-2 px-4 py-2 rounded
   {{ request()->routeIs('produk.create') ? 'bg-gray-700 text-white' : 'bg-white text-gray-800' }}">
                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
        ...
        <form method="GET" action="{{ route('produk.index') }}" class="mb-6" id="filterForm">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-3 ">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search Products"
                    class="md:col-span-9 px-4 py-2 rounded bg-white text-gray-800 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400"
                    oninput="submitFilter()">

                <div class="md:col-span-3 flex gap-2">
                    <select name="status"
                        class="flex-1 w-full px-4 py-2 rounded bg-white text-gray-800 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400"
                    ...
                    <a href="{{ route('produk.index') }}"
                        class="flex-1 w-full inline-flex items-center justify-center px-4 py-2 rounded bg-white text-gray-800 border border-gray-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400">
                        Reset
                    </a>
                </div>
            </div>
                ...
                <tbody class="text-gray-700">
                    @foreach ($produk as $p)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="p-4">
                                <p class="line-clamp-2 text-gray-700" title="{{ $p->desc }}">
                                    {{ \Illuminate\Support\Str::limit($p->desc, 20) }}
                                </p>
                            </td>
                            ...
                            <td class="p-4 text-center">
                                ...
                                {{ $p->is_active ? 'bg-green-500 text-green-800' : 'bg-red-400 text-red-800' }}">
