                ...
                <div class="max-w-7xl mx-auto w-full">
                    <div class="bg-white rounded-xl border border-gray-200 p-5 ">
                        <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
                            <h3 class="text-xl font-bold font-sans">TRASH</h3>

                            <div class="flex flex-wrap gap-2 font-sans">
                                <a href="{{ route('produk.restore') }}"
                                    class="inline-flex items-center gap-2 px-4 py-2 rounded {{ request()->routeIs('produk.restore') ? 'bg-[#333333] text-white' : 'bg-gray-100 text-gray-800' }}">
                                ...
                                <a href="{{ route('produk.index') }}"
                                    class="inline-flex items-center gap-2 px-4 py-2 rounded {{ request()->routeIs('produk.index') ? 'bg-gray-700 text-white' : 'bg-gray-100 text-gray-800' }}">
