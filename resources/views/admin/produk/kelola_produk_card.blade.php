    ...
    <div class="space-y-4">
        <div class="flex items-center justify-between">
            <div class="max-w-7xl mx-auto">
                <div class="bg-gray-100 rounded-xl border-gray-200 p-5 ">
                    <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <a href="{{ route('produk.index') }}"
                                class="inline-flex items-center gap-2 px-4 py-2 rounded {{ request()->routeIs('produk.index') ? 'bg-[#333333] text-white' : 'bg-white text-gray-800' }}">
                            ...
                            <a href="{{ route('produk.kelola_card') }}"
                                class="inline-flex items-center gap-2 px-4 py-2 rounded {{ request()->routeIs('produk.kelola_card') ? 'bg-[#333333] text-white' : 'bg-white text-gray-800' }}">
                    ...
                    <form method="GET" action="{{ route('produk.kelola_card') }}" id="filterForm" class="mb-6">
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
                            ...
                            <div class="md:col-span-3 flex gap-2">
                                <a href="{{ route('produk.kelola_card') }}"
                                    class="flex-1 flex items-center justify-center px-4 py-2 rounded bg-white border border-gray-300 hover:bg-gray-100 font-sans">
                                    All Product
                                </a>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 font-sans">
                        @forelse ($produk as $p)
                            <div
                                class="bg-white rounded-xl shadow transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:bg-gray-50 flex flex-col overflow-hidden relative group">
                                ...
                                @if (optional($p->details->first())->image_product)
                                    <img src="{{ asset('storage/' . $p->details->first()->image_product) }}"
                                        class="w-full h-48 object-cover transition rounded-2xl group-hover:scale-105">
                                @else
