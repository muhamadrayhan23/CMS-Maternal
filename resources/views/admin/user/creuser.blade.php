        ...
        <form action="{{ route('storeUser') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    <a href="{{ session('user_back', route('dashboardadmin')) }}" class="text-gray-800 hover:text-black">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input type="text"
                                    ...
                                    id="name" name="users[0][name]" value="{{ old('users.0.name') }}"
                                    placeholder="Name">
                                @error('users.*.name')
                            ...
                            <div class="mb-3 row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="email"
                                        class="w-full px-4 py-3 text-sm bg-[#F9FAFB] border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-300 transition-all placeholder:text-gray-400"
                                        id="email" name="users[0][email]" value="{{ old('users.0.email') }}"
                                        placeholder="Email">
                                    @error('users.*.email')
                                        <span class="text-danger text-sm text-red-500">*{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-3 row mt-4">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password"
                                            class="w-full px-4 py-3 text-sm bg-[#F9FAFB] border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-300 transition-all placeholder:text-gray-400"
                                            id="password" name="users[0][password]" value="{{ old('users.0.password') }}"
                                ...
                                <div class="mb-3 row mt-4">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password"
                                            class="w-full px-4 py-3 text-sm bg-[#F9FAFB] border border-gray-200 rounded-lg"
                                            id="password_confirmation" name="users[0][password_confirmation]"
    ...
    <script>
        ...
        function AddRow() {
            ...
            <div class="space-y-2">
                ...
                <input type="password" name="users[${rowCount}][password_confirmation]" placeholder="Confirm Password"
                    class="w-full px-4 py-3 text-sm bg-[#F9FAFB] border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-300 transition-all placeholder:text-gray-400">
        `;
