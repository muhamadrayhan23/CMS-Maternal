        ...
        <form action="{{ route('storeAnnouncement') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-sm font-bold tracking-wider text-gray-800 uppercase">Add New Announcement</h1>
                </div>
                <button type="submit"
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
                ...
                <div id="link-container" class="space-y-6">
                    <div class="space-y-6 border border-gray-100 rounded-xl p-6 bg-white relative">
                        <div class="mb-3 row">
                            <label for="announcement_name" class="text-sm font-medium text-gray-700">Announcement
                                Title</label>
                            <div class="col-md-6">
                                <input type="text"
                                    ...
                                    id="announcement_name" name="announcements[0][name]"
                            ...
                            <div class="mb-3 row mt-4">
                                <label for="announcement_address" class="text-sm font-medium text-gray-700">Announcement
                                    Link Address</label>
                                <div class="col-md-6">
                                    <input type="text"
                                        class="w-full px-4 py-3 text-sm bg-[#F9FAFB] border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-300 transition-all placeholder:text-gray-400"
                                        id="announcement_address" name="announcements[0][address]"
                                        value="{{ old('announcements.0.address') }}"
                                        placeholder="Announcement Link Address">
                                ...
                                <div class="mb-3 row mt-4">
                                    <label for="announcement_image" class="text-sm font-medium text-gray-700">Announcement
                                        Image</label>
                                    <div class="relative flex items-center">
                                        ...
                                        <label
                                            ...
                                            Choose File
                                            <input type="file" id="announcement_image" name="announcements[0][image]"
                                                value="{{ old('announcements.0.image') }}" class="hidden"
    ...
    <script>
        ...
        function AddRow() {
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="announcements[${rowCount}][name]" placeholder="Announcement Title"
                    class="w-full px-4 py-3 text-sm bg-[#F9FAFB] border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-300 transition-all placeholder:text-gray-400">
            </div>
            <div class="space-y-2">
                <label class="text-sm font-medium text-gray-700">Link</label>
                <input type="text" name="announcements[${rowCount}][address]" placeholder="Announcement Link Address"
                    class="w-full px-4 py-3 text-sm bg-[#F9FAFB] border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-300 transition-all placeholder:text-gray-400">
            </div>
            <div class="space-y-2">
                ...
                <div class="relative flex items-center">
                    ...
                    <label class="absolute right-2 px-3 py-1.5 text-xs font-medium text-gray-600 bg-[#E5E7EB] border border-gray-300 rounded cursor-pointer hover:bg-gray-300 transition-colors italic">
                        Choose File
                        <input type="file" name="announcements[${rowCount}][image]" class="hidden" onchange="updateFileName(this)">
                    </label>
                </div>
            </div>
        `;
