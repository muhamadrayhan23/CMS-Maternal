                ...
                <div id="banner-container" class="space-y-6">
                    <div class="banner-row space-y-4 md:space-y-6 border border-gray-100 rounded-xl p-6 bg-white relative">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="banner_name" placeholder="Banner Name (Title)"
                                ...
                                <div class="relative">
                                    <div
                                        ...
                                        <svg id="placeholder-icon"
                                            class="w-12 h-12 text-gray-300 {{ $banner->banner_image ? 'hidden' : '' }}"
                                    ...
                                    <div class="mt-3 flex flex-col items-center pb-2">
                                        <p id="file-name-display"
                                            class="mb-2 text-[10px] text-gray-400 font-medium truncate w-full text-center px-4">
                                        ...
                                        <label for="file-upload" class="cursor-pointer">
                                            ...
                                            <input id="file-upload" name="banner_image" type="file" class="hidden"
