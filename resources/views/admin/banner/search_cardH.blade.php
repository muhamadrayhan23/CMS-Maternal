                        ...
                        <div class="action-menu hidden absolute right-0 mt-2 w-30 bg-white border border-gray-200 rounded-xl shadow-lg z-50 overflow-hidden text-left">
                            <form method="POST" action="{{ route('banner.toggle', $b->id_banner) }}">
                                ...
                                <button class="w-full px-4 py-3 text-sm hover:bg-gray-200 transition-all flex gap-2.5 text-left">
                                    ...
                                    @else
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                         class="lucide lucide-circle-plus-icon lucide-circle-plus"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="M12 8v8"/>
                                        </svg>
                                        <span>Publish</span>
                                    @endif
                                </button>
                            </form>
                            <a href="{{ route('editB', $b->id_banner) }}" class="flex gap-3 px-4 py-3 text-sm hover:bg-gray-200 transition-all border-t border-gray-50 text-left">
