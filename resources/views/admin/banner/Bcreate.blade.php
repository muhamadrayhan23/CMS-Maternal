        ...
        <form action="{{ route('addBanner') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-4 md:p-8 shadow-sm">
                ...
                <div id="banner-container" class="space-y-6">
                    <div
                        class="banner-row space-y-4 md:space-y-6 border border-gray-100 rounded-xl p-4 md:p-6 bg-white relative">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="banners[0][name]" placeholder="Banner Name (Title)"
                                class="w-full px-4 py-3 text-xs md:text-sm mt-1 bg-[#F9FAFB] border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-300 transition-all placeholder:text-gray-400"
                                required>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div
                                class="border-2 border-dashed border-gray-300 rounded-2xl p-2 w-full max-w-md bg-white hover:bg-gray-50 transition-all relative">
                                <div class="preview-container relative">
                                    <div
                                        class="w-full aspect-[1920/1080] rounded-xl overflow-hidden bg-gray-100 flex items-center justify-center border border-gray-100">

                                        <img class="image-preview w-full h-full object-cover hidden" src="">

                                        <svg class="placeholder-icon w-12 h-12 text-gray-300" fill="none"
                                    ...
                                    <div class="mt-3 flex flex-col items-center pb-2">
                                        <p
                                            class="file-name-display mb-2 text-[10px] text-gray-400 font-medium truncate w-full text-center px-4">
                                            No file chosen</p>

                                        <label class="cursor-pointer">
                                            <span
                                                class="px-4 py-1.5 bg-blue-600 text-white text-xs font-semibold rounded-lg shadow-md hover:bg-blue-700 transition-all">
                                                Choose File
                                            </span>
                                            <input name="banners[0][image]" type="file" class="hidden" accept="image/*"
