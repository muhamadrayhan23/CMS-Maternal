...
<body class="flex flex-col font-sans min-h-screen overflow-x-hidden">
    ...
    <a href="https://wa.me/625349770100"
        ...
        <span class="mr-3 bg-gray-800 text-white text-xs px-3 py-2 rounded-lg shadow-lg
                 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            Chat Admin!
        </span>

        <div class="bg-[#25D366] w-14 h-14 rounded-full shadow-lg flex items-center justify-center
