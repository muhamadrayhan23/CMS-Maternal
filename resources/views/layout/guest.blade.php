...
<body class="flex flex-col font-sans min-h-screen overflow-x-hidden">
    ...
    {{-- --- wa --- --}}
    <a href="https://wa.me/6287824157666" class="fixed bottom-6 right-6 z-50 flex items-center group">

        <span
            class="mr-3 bg-gray-800 text-white text-xs px-3 py-2 rounded-lg shadow-lg
                 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            Chat Admin!
        </span>

        <div
            class="bg-[#25D366] w-14 h-14 rounded-full shadow-lg flex items-center justify-center
