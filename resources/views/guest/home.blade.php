...
@section('content')
    ...
    <div id="default-carousel" data-carousel="slide" class="group relative">
        ...
        <div class="relative w-full h-screen md:h-screen font-sans -mt-22 overflow-hidden">
            @foreach ($banners as $index => $banner)
                <div class="{{ $index === 0 ? '' : 'hidden' }} duration-700 ease-in-out"
                    ...
                    <img src="{{ asset($banner->banner_image) }}" class="absolute inset-0 w-full h-full object-cover"
                        alt="Banner {{ $index + 1 }}">
        ...
        cursor-pointer focus:outline-none opacity-0 group-hover:opacity-100 transition-opacity duration-400">
            <span
                class="inline-flex items-center justify-center w-9 h-9 md:w-10 md:h-10 rounded-full border border-white transition
    ...
    <div id="product-cards" class="relative flex flex-col md:flex-row gap-10 md:gap-20
    px-5 md:px-10 py-14">
        ...
        <div class="flex flex-col justify-center w-full md:w-[420px] shrink-0">
            ...
            <p class="my-5 text-justify text-sm md:text-base leading-relaxed">
                Timeless daily wear designed for comfort and sensory connection. Each piece is crafted to feel natural on
                your skin, offering ease you can return to every day.
                <br><br>
                Through tactile paracord details, our creations become a quiet sanctuary helping you slow down, reconnect
                with nature, and find calm in a crowded world.
            </p>

            <a href="{{ route('products') }}" class="inline-flex items-center px-8 py-3 bg-black text-white gap-2 w-fit">
                → View More
            </a>
        </div>
                ...
                <div id="cardTrack"
                    ...
                    @foreach ($products as $product)
                        <div class="w-[300px] items-center sm:w-[300px] md:w-[420px] shrink-0">
                            ...
                            <div
                                class="relative aspect-square rounded-xl transition-transform duration-300 hover:scale-105 will-change-transform">

                                <a href="{{ route('detproduct', $product->id_product) }}">
                                    {{-- PERBAIKAN: Menghapus 'storage/' --}}
                                    <img src="{{ asset($product->details->first()->image_product) }}"
                                ...
                                @if (!$product->is_available)
                                    <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                                        <span
                                            class="bg-red-700/70 text-white w-full h-16 flex items-center justify-center text-sm font-semibold">
                                            SOLD OUT
                                        </span>
                                    </div>
                                @endif
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="relative w-1/2">
            <a href="{{ route('about') }}">
                <img src="{{ asset('img/about/about1.jpg') }}" alt="" class="w-full h-full object-cover">
            </a>

            <div class="absolute bottom-6 left-6 flex flex-col gap-1 px-5">
                <p class="text-white font-sans">
                    Driven by a passion and rocking a rebellious spirit, we create timeless pieces that blend comfort and
                    style, designed to move with you and last through the years.
                </p>
                <a href="{{ route('about') }}" class="text-white font-sans underline underline-offset-4">
                    view more
                </a>
            </div>
        </div>
        ...
        <div class="relative w-1/2">
            <a href="{{ route('products') }}">
                <img src="{{ asset('img/about/about4.jpg') }}" alt="" class="w-full h-full object-cover">
            </a>

            <div class="absolute bottom-6 right-6 flex flex-col gap-1 px-5">
                <p class="text-white font-sans">
                    Made to Move, Made to Last
                </p>
                <a href="{{ route('products') }}" class="text-white font-sans underline underline-offset-4">
                    view more
                </a>
            </div>
        </div>
